...
<div class="ufps-container-fluid" >        
        ...
        <section id="information">
            <h2>Registrar Nueva Direccion de Doctorado</h2>

        <form  class="contact_form" action="doctoradoController" method="post" style="box-shadow: 0px 0px 5px 1px black; margin: 1%; padding-bottom:1%;">
        <div id="registro">
            <ul>
              ...
              <button class="ufps-btn" type="submit" >Registrar Doctorado</button>
