            ...
            <div class="col-md-9 col-lg-8 mx-auto">
              <form method="post" action="LoginController">
                ...
                <div class="text-center">
                  <a class="small" href="#" style="color: #d9534f" data-toggle="modal" data-target="#exampleModal">Olvidaste la contraseña?</a></div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Se te enviara un correo para restablecer la contraseña.</h5>
