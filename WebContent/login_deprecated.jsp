        ...
        <aside  id="aside" class="main">
            ...
            <div class="login-form">
                ...
                <form method="post" action="LoginController">
                    ...
                    <p><a href="#" onclick="openModal('modal')">¿Olvidaste tu contraseña?</a></p>
                    <div id="modal" class="ufps-modal">
                        <div class="ufps-modal-content">
                            ...
                            <div class="ufps-modal-body">
                                <label for="email_director">digita tu email para reestablecer la contraseña *: </label>
                                ...
                                <center><a href="#" class="ufps-btn ufps-btn-green">Reestablecer contraseña</a> </center>    
                            </div>
                    ...
                    <p><a href="registro_grupo.jsp" >Registra Aquí tu grupo de investigación</a></p>
